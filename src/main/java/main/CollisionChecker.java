...
public class CollisionChecker {
    ...
    public void checkTile(Enity entity) {
    ...
    public int checkEnity(Enity entity, Enity[] target) {
        int index = 999;
    ...
    public int checkObject(Enity entity, boolean player) {
        int index = 999;
    ...
    public boolean checkPlayer(Enity enity) {
        boolean contectPlayer = false;
        ...
        if (enity.solidArea.intersects(gp.player.solidArea)) {
